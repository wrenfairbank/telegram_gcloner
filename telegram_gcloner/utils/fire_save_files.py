...
def fire_save_files(update, context, folder_ids, text, dest_folder):
    ...
    rsp = context.bot.send_message(chat_id=chat_id, text=message, parse_mode=ParseMode.HTML)
    ...
    for folder_id in folder_ids:
        ...
        if critical_fault is True:
            message = '{}{}❌\n{}\n{}\n\n'.format(message, message_progress_heading, message_progress_content, link_text)
